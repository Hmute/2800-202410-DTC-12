document.addEventListener('DOMContentLoaded', () => {
   ...
   function flipLogo(callback) {
       ...
       const interval = setInterval(() => {
           ...
           logo.style.width = '150px'; // Increase size for animation
           logo.style.height = '150px'; // Increase size for animation
           frame++;
   ...
   function flipLogoBack() {
       ...
       const interval = setInterval(() => {
           if (frame < 1) {
               ...
               logo.style.width = ''; // Reset size
               logo.style.height = ''; // Reset size
               return;
           }
           logo.src = `images/Easter_Egg_Animation/frame${frame}.png`;
           logo.style.width = '150px'; // Increase size for animation
